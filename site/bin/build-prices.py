...
//
// GENERATED by site/bin/build-prices.py from site/_data/membership.yml and
// site/_data/classes.yml. Do not edit this file — edit those, run the script, and
...
def load(name):
    with open(SITE / "_data" / name, encoding="utf-8") as handle:
    ...
    if args.check:
        ...
        if current != rendered:
            print(
                ...
                "A price changed in site/_data/ without the broker's copy being "
                "rebuilt. Run:\n\n    python3 site/bin/build-prices.py\n\n"
